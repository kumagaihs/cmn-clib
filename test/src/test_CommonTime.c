...
static void test_CmnTime_DateTimeSetNow(CmnTest_Case *testCase)
{
	CmnTime_DateTime datetime;
	CmnTime_DateTimeSetNow(&datetime);
...
void test_CommonTime_AddCase(CmnTest_Plan *plan)
{
