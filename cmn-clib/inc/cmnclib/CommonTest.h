...
/** テストを実行する */
D_EXTERN void CmnTest_Run(CmnTestPlan *plan, _Bool realtimeReport);
/** テストプランを破棄する */
...
/** データ検証 */
D_EXTERN _Bool CmnTest_AssertData(CmnTestCase *testCase, long line, void *actual, void *expected, size_t dataLen);
/** 検証NGを記録する */
D_EXTERN _Bool CmnTest_AssertNG(CmnTestCase *testCase, long line);
